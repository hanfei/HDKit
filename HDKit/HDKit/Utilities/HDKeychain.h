...
@class HDKeychainItem;

@interface HDKeychain : NSObject
 ...
 */
typedef NS_ENUM (NSUInteger, HDKeychainErrorCode) {
    HDKeychainErrorUnimplemented = 1, ///< Function or operation not implemented.
    HDKeychainErrorIO, ///< I/O error (bummers)
    HDKeychainErrorOpWr, ///< File already open with with write permission.
    HDKeychainErrorParam, ///< One or more parameters passed to a function where not valid.
    HDKeychainErrorAllocate, ///< Failed to allocate memory.
    HDKeychainErrorUserCanceled, ///< User canceled the operation.
    HDKeychainErrorBadReq, ///< Bad parameter or invalid state for operation.
    HDKeychainErrorInternalComponent, ///< Internal...
    HDKeychainErrorNotAvailable, ///< No keychain is available. You may need to restart your computer.
    HDKeychainErrorDuplicateItem, ///< The specified item already exists in the keychain.
    HDKeychainErrorItemNotFound, ///< The specified item could not be found in the keychain.
    HDKeychainErrorInteractionNotAllowed, ///< User interaction is not allowed.
    HDKeychainErrorDecode, ///< Unable to decode the provided data.
    HDKeychainErrorAuthFailed, ///< The user name or passphrase you entered is not.
};
 ...
 */
typedef NS_ENUM (NSUInteger, HDKeychainAccessible) {
    HDKeychainAccessibleNone = 0, ///< no value
    ...
    /** Item data can only be accessed
     ...
     backups. */
    HDKeychainAccessibleWhenUnlocked,
    ...
    HDKeychainAccessibleWhenPasscodeSetThisDeviceOnly,
    ...
    HDKeychainAccessibleWhenUnlockedThisDeviceOnly,
    ...
    /** Item data can
     ...
     be missing.*/
    HDKeychainAccessibleAfterFirstUnlockThisDeviceOnly,
    ...
    HDKeychainAccessibleAlwaysThisDeviceOnly,
};

/**
 Whether the item in question can be synchronized.
 */
typedef NS_ENUM (NSUInteger, HDKeychainQuerySynchronizationMode) {
    
    /** Default, Don't care for synchonization  */
    HDKeychainQuerySynchronizationModeAny = 0,
    
    /** Do not synchronizable */
    HDKeychainQuerySynchronizationModeNo,
    
    /** To add a new item which can be synced to other devices, or to obtain
     synchronizable results from a query*/
    HDKeychainQuerySynchronizationModeYes,
 ...
 */
@interface HDKeychainItem : NSObject <NSCopying>
...
@property (nonatomic, assign) HDKeychainAccessible accessible; ///< kSecAttrAccessible
@property (nonatomic, assign) HDKeychainQuerySynchronizationMode synchronizable NS_AVAILABLE_IOS(7_0); ///< kSecAttrSynchronizable
