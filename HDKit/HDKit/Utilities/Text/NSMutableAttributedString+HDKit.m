...
#import "NSMutableAttributedString+HDKit.h"
#import "UIFont+HDKit.h"

@implementation NSMutableAttributedString (HDKit)
...
- (void)setLigature:(HDTextLigature)ligature range:(NSRange)range {
...
- (void)setUnderlineStyle:(HDTextUnderlineStyle)style range:(NSRange)range {
